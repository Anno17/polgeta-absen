...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="data-today">
            <button><a href="forms/pendidikan/input.php">TAMBAH</a></button>
        ...
        <tr>
            ...
            <td><?php echo "<a href='controller/pendidikan.php?id=".$id."'>Hapus</a> | <a href='forms/pendidikan/edit.php?id=".$id."'>Edit</a>"; ?></td>
        </tr>
        <?php } ?>
            </table>
